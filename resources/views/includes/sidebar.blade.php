    ...
    <li
        ...
        <div id="collapseLaporan"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item {{ Request::is('admin/report-orders') ? ' active' : '' }}"
                    href="{{ route('admin.cetak.orders') }}">PENJUALAN</a>
                <a class="collapse-item {{ Request::is('admin/report-product') ? ' active' : '' }}"
                    href="{{ route('admin.cetak.product') }}">PRODUK</a>
            </div>
        </div>
    </li>
    <!-- Divider -->
