                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:550px;">
                                                                <img alt="" height="auto"
                                                                    src="{{ asset('assets/img/email/header.jpg') }}"
                                                        ...
                                                        <tr>
                                                            <td align="center" vertical-align="middle"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center" bgcolor="#E87B17"
                                                                                role="presentation"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left"
                                                style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                                <div
                                                    style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;line-height:20px;text-align:left;color:#071c4d;">
                                                    Butuh Bantuan ?</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="width: 50px;">
                                                            <img src=" {{ asset('assets/img/email/ic_help.png') }} "
                                                                width="50px">
                                                        </td>
                                                        <td
                                                            style="font-size:18px; padding-left:10px; color:#071c4d; font-family:Assistant, Helvetica, Arial, sanf-serif; font-weight:600">
                                                            hello@adminsport.my.id <br> 087732677337 </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
        ...
        <div style="margin:0px auto;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                <tbody>
                    <tr>
                        <td
                            style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:20px;padding-top:10px;text-align:center;">
                            <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:600px;" ><![endif]-->
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                                <div
                                                    style="font-family:Assistant, Helvetica, Arial, sanf-serif;font-size:15px;line-height:1;text-align:center;color:#888b93;">
                                                    2021 Copyright Store Commerce - All right reserved.</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
